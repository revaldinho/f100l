...
|  F    |  I |    | R   | P               |                     |          |                      |
+-------+----+----+-----+-----------------+----+----------------+----------+----------------------+
|4'b1011|1'b0|     11'b<non-zero addr>    |           none      | CMP N    | TBC                  |
+-------+----+----+-----+-----------------+----+----------------+----------+----------------------+ 
|4'b1011|1'b0|     11'b000000000000       |        16b'<data>   | CMP ,D   | TBC                  |
+-------+----+----+-----+-----------------+----+----------------+----------+----------------------+
|4'b1011|1'b1|1'bx|2'bx0|8'b<non-zero ptr>|           none      | CMP /P   | TBC                  |
+-------+----+----+-----+-----------------+----+----------------+----------+----------------------+
|4'b1011|1'b1|1'bx|2'b01|8'b<non-zero ptr>|           none      | CMP /P+  | TBC                  |
+-------+----+----+-----+-----------------+----+----------------+----------+----------------------+ 
|4'b1011|1'b1|1'bx|2'b11|8'b<non-zero ptr>|           none      | CMP /P-  | TBC                  |
+-------+----+----+-----+-----------------+----+----------------+----------+----------------------+ 
|4'b1011|1'b1|1'bx|2'bxx|8'b00000000      |1'bx|   15b'<addr>   | CMP .W   | TBC                  |
+-------+----+----+-----+-----------------+----+----------------+----------+----------------------+
